...
<div id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
    ...
    <div class="itemHeader">
        ...
        <!-- Item title -->
        <?php if($_REQUEST['preview'] == 1): ?>
        <span class="preview-mode label label-danger">Chế độ Xem trước</span>
        <?php endif; ?>
        <h2 class="itemTitle">
    ...
    <div class="itemBody">
      <div id="table-wrap"><div id="table-header"><i class="fa fa-list-ul" aria-hidden="true"></i> <span class="table-header-title">Nội dung bài viết</span></div><ul></ul></div>
      ...
      <?php endif; ?>
        ...
        <?php endif; ?>
        <!-- <button type="button" id="ftwp-trigger" class="ftwp-shape-round ftwp-border-medium ftwp-transform-right-center ftwp-fade-trigger" title="click To Maximize The Table Of Contents" style="right: 1122.25px; left: auto;"><span class="ftwp-trigger-icon ftwp-icon-bullet"></span></button> -->
        <div class="clr"></div>
        ...
        <div class="itemExtraFields">
            ...
            <ul>
                ...
                <div class="catItemReadMore">
                    <div class="button_bot button_bot_detail">
                            <span id="registration"><a target="_blank" href="<?php echo LANDINGPAGE_LINK; ?>">Đăng ký tư vấn</a></span>
                            <!-- <span id="see_more"><a href="index.php?Itemid=343">Liên hệ với tư vấn</a></span> -->
                        </div>
        ...
        <div class="itemContentFooter">
            ...
            <div class="author-bottom">
                ...
                <a rel="author" href="<?php echo $this->item->author->link; ?>">
                  <img class="image-avatar float-left" src="<?php echo $this->item->author->avatar; ?>" onerror="if (this.src != 'error.jpg') this.src = '<?php echo JURI::root().'images/avatark2/avatardefault.png' ?>'" alt="<?php echo K2HelperUtilities::cleanHtml($this->item->author->name); ?>" />
                </a>
    ...
    <div class="itemSocialSharing">
        ...
        <div class="itemFacebookButton">
            ...
            <!-- <div class="fb-like fb-xfbml-parse-ignore fb-share-button" data-href="<?php echo $this->item->sharinglink; ?>" data-width="160" data-layout="button_count" data-action="like" data-size="large" data-show-faces="true" data-share="true"></div> -->
            <div class="fb-like" data-href="<?php echo $this->item->sharinglink; ?>" data-layout="button_count" data-size="large"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fdevelopers.facebook.com%2Fdocs%2Fplugins%2F&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">Like</a></div>
            <div class=" fb-share-button" data-href="<?php echo $this->item->sharinglink; ?>" data-layout="button_count" data-size="large"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fdevelopers.facebook.com%2Fdocs%2Fplugins%2F&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">Chia sẻ</a></div>
        </div>
        <?php endif; ?>
    ...
    */
    ...
    <?php if($this->item->params->get('itemAuthorLatest') && isset($this->itemsByCat)): ?>
    ...
    if($this->item->catid == LIFE_INSURANCE ||
    $this->item->catid == HEALTH_INSURANCE ||
    $this->item->catid == TRAVEL_INSURANCE ||
    $this->item->catid == CAR_INSURANCE ||
    $this->item->catid == HOME_INSURANCE ||
    $this->item->catid == CRITICAL_ILLNESS_INSURANCE
    ):
    ?>
    <div class="itemAuthorLatest" id="itemAuthorLatest">
        <h3>Sản phẩm liên quan</h3>
        <ul>
            <?php foreach($this->itemsByCat as $key=>$item): ?>
            <li class="<?php echo ($key%2) ? "odd" : "even"; ?>">
                <a href="<?php echo $item->link ?>"><?php echo $item->title; ?></a>
    ...
    <?php else: ?>
      <?php
        if($this->item->catid != 79):
      ?>
      <div class="itemAuthorLatest relatedItems" id="itemAuthorLatest">
          <h3><?php echo $this->item->catid == 107 ? 'Video': 'Bài viết'; ?> liên quan</h3>
          <ul>
              <?php foreach($this->itemsByCat as $key=>$item):  ?>
              <li class="<?php echo ($key%2) ? "odd" : "even"; ?>">
                <?php
                $imageMediumArray = explode("/media/",$item->imageMedium);

                $linkImageMedium = '';
                if($imageMediumArray[1]!=''){
                  $imageMediumTArray = explode("?t=",$imageMediumArray[1]);
                  $linkImageMedium = JPATH_ROOT . '/media/'.$imageMediumTArray[0];
                }else{
                  $linkImageMedium = '';
                }

                ?>
                <?php if($linkImageMedium != '' && JFile::exists($linkImageMedium)){ ?>
                ...
                <div class="catItemDateCreated">
                  ...
                  <a class="relatedItemTitle" href="<?php echo $item->link ?>"><?php echo $item->title; ?></a>
              </li>
              <?php endforeach; ?>
          </ul>
          <div class="clr"></div>
    ...
    */
    ...
    <div class="itemRelated" style="display:none;">
...
jQuery( document ).ready(function() {
  var listIndexTable = '';
  jQuery( ".itemFullText h3" ).each(function( index ) {
  //console.log( index + ": " + jQuery( this ).text() );
  listIndexTable = listIndexTable + '<li onclick="scrollToID(\'table-list-'+index+'\')">'+jQuery( this ).text()+'</li>';
  jQuery( this ).addClass( "table-list-" + index );
  jQuery( this ).attr('id', "table-list-" + index );
  });
  if(listIndexTable != ''){
    jQuery( "#table-wrap" ).css( "display","block");
  }
  jQuery( "#table-wrap ul" ).html(listIndexTable);
